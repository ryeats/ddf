...
public interface AttributeValidatorRegistry {
    /**
     * Registers the given {@link AttributeValidator}s to the attribute with the given name.
     *
     ...
     */
    void registerValidators(String attributeName,
            Collection<? extends AttributeValidator> validators);

    /**
     * Deregisters all {@link AttributeValidator}s associated with the given attribute.
     *
     * @param attributeName the name of the attribute whose validators will be deregistered
     */
    void deregisterValidators(String attributeName);

    /**
     * Gets all the {@link AttributeValidator}s associated with the given attribute.
     *
     * @param attributeName the name of the attribute
     * @return the set of {@link AttributeValidator}s registered to the attribute
     */
