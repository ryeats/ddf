...
public class RequiredAttributesMetacardValidatorTest {
    ...
    public void testValidMetacard() {
        ...
        validate(metacard, Sets.newHashSet("title", "created", "thumbnail"), 0);
    }
    ...
    private void validate(final Metacard metacard, final Set<String> requiredAttributes,
        ...
        final MetacardValidationReport report = validator.validateMetacard(metacard);
        assertThat(report.getMetacardValidationViolations()
