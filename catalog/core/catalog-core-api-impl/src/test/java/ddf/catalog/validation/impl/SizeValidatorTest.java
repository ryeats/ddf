...
public class SizeValidatorTest {
    ...
    public void testValidStringValue() {
        validate(new AttributeImpl("test", StringUtils.repeat("a", 33)), 0, 36, 0);
    }

    @Test
    public void testValidArrayValue() {
        validate(new AttributeImpl("test", new byte[15]), 10, 15, 0);
    }

    @Test
    public void testValidCollectionValue() {
        validate(new AttributeImpl("test", Sets.newHashSet(1, 2, 3, 4, 5)), 4, 6, 0);
    }
    ...
    public void testValidMapValue() {
        ...
        map.put(1, 2);
        validate(new AttributeImpl("test", map), 0, 5, 0);
    }

    @Test
    public void testInvalidStringValue() {
        validate(new AttributeImpl("test", StringUtils.repeat("a", 33)), 40, 50, 1);
    }

    @Test
    public void testInvalidArrayValue() {
        validate(new AttributeImpl("test", new byte[15]), 20, 25, 1);
    }

    @Test
    public void testInvalidCollectionValue() {
        validate(new AttributeImpl("test", Sets.newHashSet(1, 2, 3, 4, 5)), 6, 8, 1);
    }

    @Test
    public void testInvalidMapValue() {
        validate(new AttributeImpl("test", new HashMap<>()), 5, 10, 1);
    }
