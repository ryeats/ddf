...
public class AttributeRegistryImplTest {
    ...
    public void testAddAttribute() {
        ...
        final AttributeDescriptor registryDescriptor = registry.getAttributeDescriptor("test");
        assertThat(descriptor, is(registryDescriptor));
    }
    ...
    public void testRemoveAttribute() {
        final AttributeDescriptor descriptor = new AttributeDescriptorImpl("test",
                ...
                BasicTypes.STRING_TYPE);
        assertThat(registry.registerAttribute(descriptor), is(true));
        assertThat(registry.getAttributeDescriptor("test"), notNullValue());

        registry.deregisterAttribute("test");
        assertThat(registry.getAttributeDescriptor("test"), nullValue());
    }
    ...
    public void testAddAttributeWithSameName() {
        ...
        assertThat(registry.getAttributeDescriptor("test"), is(descriptor1));
    }
