 ...
 * `arguments`: (2) [integer: lower bound (inclusive), integer: upper bound (inclusive)]
 - `decimalrange`
 * `arguments`: two possible argument lists
 ** (2) [decimal number: lower bound (inclusive), decimal number: upper bound (inclusive)]
 ** (3) [decimal number: lower bound (inclusive), decimal number: upper bound (inclusive), decimal number: epsilon (the maximum tolerable error on either side of the range)]
 - `enumeration`
        ...
        "classification": [
            {
                ...
                "arguments": ["UNCLASSIFIED", "SECRET", "TOP SECRET"]
            }
        ]
    }
}
